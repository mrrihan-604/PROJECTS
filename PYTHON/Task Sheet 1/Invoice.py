# Take customer and product information as input
...
# Calculate total price, GST amount, and final bill amount
...
print("                                INVOICE          ")
print("-"*75)
print(f"Customer Name    : {custommer_name}")
...
print(f"{product_name:<20} {product_price:<20} {quntity:<20} {total_price}")
print("-"*75)
